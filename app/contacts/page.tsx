...
const locations = [
  { label: "Церква Еммануїл", address: "вул. О. Кобилянської, 53, Чернівці", mapQuery: "вулиця Ольги Кобилянської, 53, Чернівці, Чернівецький район, Чернівецька область, 58002, Україна" },
  { label: "Друга адреса", address: "вул. О. Криворучка, 57, Чернівці", mapQuery: "вулиця Ореста Криворучка, 57, Чернівці, Чернівецький район, Чернівецька область, 58010, Україна" },
  { label: "Реабілітаційний центр", address: "с. Великий Кучурів, Чернівецька обл.", mapQuery: "Великий Кучурів, Чернівецький район, Чернівецька область, Україна" },
];
