...
const locations = [
  { label: "Церква Еммануїл", address: "вул. О. Кобилянської, 53, Чернівці, Україна" },
  { label: "Друга адреса", address: "вул. О. Криворучка, 57, Чернівці, Україна" },
  { label: "Реабілітаційний центр", address: "с. Великий Кучурів, Чернівецька область, Україна" },
];
