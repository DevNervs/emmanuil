...
const hlsSrc = "/media/hero-hls-grade3/master.m3u8";
const fallbackSrc = "/media/hero-worship-loop.mp4?v=grade3";
const posterSrc = "/media/hero-worship-poster.jpg?v=grade3";
const posterSrcSet =
