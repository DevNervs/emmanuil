...
export const metadata: Metadata = { title: "Пастори та команда церкви", description: "Пастори, диякони та служителі християнської церкви Еммануїл у Чернівцях.", alternates: { canonical: "/team" } };
