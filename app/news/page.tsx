...
export const metadata: Metadata = { title: "Новини та архів життя церкви", description: "Події, історії, відео та архів життя християнської церкви Еммануїл у Чернівцях.", alternates: { canonical: "/news" } };
